...
import 'package:film_ku/models/actor_model.dart';
...
class Search with ChangeNotifier {
  ...
  Future<void> searchMovies(String query, int page) async {
    ...
    final url =
        '$BASE_URL/search/movie?api_key=$apiKey&language=en-US&query=$query&page=$page&include_adult=false';
  ...
  Future<void> searchTVShows(String query, int page) async {
    var apiKey = ' ADD YOUR API KEY HERE';
    final url =
        '$BASE_URL/search/tv?api_key=$apiKey&language=en-US&query=$query&page=$page&include_adult=false';
  ...
  Future<void> searchPerson(String query, int page) async {
    var apiKey = ' ADD YOUR API KEY HERE';
    final url =
        '$BASE_URL/search/person?api_key=$apiKey&language=en-US&query=$query&$page=1&include_adult=false';
